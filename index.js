...
if(answer === 'follow'){
    let answer = window.prompt(`You follow the cat to a colony of cats, 
...
let answer = window.prompt(`You come across a chamber that reaches upward to a shining light above. 
There is a long, winding staircase, and a much quicker, 
but rickety-looking ladder that leads up toward the light. 
Which do you take?`)
}